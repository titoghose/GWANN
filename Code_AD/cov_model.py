...
def gen_cov_encodings(label:str, param_folder:str, 
    ...
    model_path=f'{sys_params["LOGS_BASE_FOLDER"]}/{label}_CovSens1.3_GroupAttention_[128,64,16]_Dr_0.3_LR:0.0001_BS:256_Optim:adam/BCR/0_BCR.pt'
