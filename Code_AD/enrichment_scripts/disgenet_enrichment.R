...
nnHits = read.table("../results_Sens8_v4_avg/gene_hits.csv", header=T)
...
ggsave(filename = "../results_Sens8_v4_avg/enrichments/disgenet_enrichment.png", dpi = 300, plot = resPlot_out)
ggsave(filename = "../results_Sens8_v4_avg/enrichments/disgenet_enrichment.png", plot = resPlot_out)
write.table(res_enrich@qresult, file = "../results_Sens8_v4_avg/enrichments/disgenet_enrichment.tsv", sep = "\t", row.names = FALSE)
# ---------------------------------------------------------------------------- #