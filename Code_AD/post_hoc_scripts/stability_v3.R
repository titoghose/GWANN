...
sFileShuf = "results_Sens8_dummy_robust_combined.csv"
...
ggsave("FPR_TPR_vs_theta1.png", width = 15, height = 10)
...
# save plot
ggsave("hit_count_vs_num_seeds.png", width = 10, height = 10)
