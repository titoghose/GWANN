...
for v in ${versions[@]}
do
    log_folder="/home/upamanyu/GWANN/Code_AD/NN_Logs/FH_AD_ChrGenePCA_"$seed""$seed"_GS10_"$v"_GWANNet5_[32,16]_Dr_0.5_LR:0.005_BS:256_Optim:adam"
    for chrom in ${chroms[@]}
    do
        chrom_log_folder="/home/upamanyu/GWANN/Code_AD/NN_Logs/Chr"$chrom"_FH_AD_ChrGenePCA_"$seed""$seed"_GS10_"$v"_GWANNet5_[32,16]_Dr_0.5_LR:0.005_BS:256_Optim:adam"
